...
saveRDS(check.all.diagnosis,
        "./outputs/check.all.diagnosis.comp.RDS")
...
saveRDS(temp.title,
        "./outputs/Model.predictions.comp.RDS")
...
for (DBH2test in c(25,50,100,150)){
  ...
  saveRDS(
    temp3.title,paste0("./outputs/Main.OP.",DBH2test,".comp.RDS"))
}
...
# scp /home/femeunier/Documents/projects/LianaRemovalRevisited/scripts/compaire.sites.status_hpc.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
