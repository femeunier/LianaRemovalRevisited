...
dumb <- write_bash_submission(file = file.path(getwd(),"all_jobs_Bayesian_CA.sh"),
                              list_files = list_dir,
                              job_name = jobname)

# scp /home/femeunier/Documents/projects/LianaRemovalRevisited/scripts/submit.sites.CA.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
