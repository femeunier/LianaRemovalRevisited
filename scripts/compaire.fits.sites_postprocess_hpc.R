...
for (isite in seq(1,length(sites))){
  ...
  dir.create(file.path("./data/",csite.corrected),
             showWarnings = FALSE)
...
# scp /home/femeunier/Documents/projects/LianaRemovalRevisited/scripts/compaire.fits.sites_postprocess_hpc.R hpc:/kyukon/data/gent/vo/000/gvo00074/felicien/R/
