    ...
    if ("weibull" %in% tolower(names)){
      ...
      if ("all" %in% tolower(fixed.effect)){
        ...
        if (!("none" %in% tolower(random.effect))){
          ...
          priors.list[["weibull"]] <- priors.list[["weibull"]] +
            ...
            set_prior("student_t(3, 0, 0.05)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.05)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "sp") +
            set_prior("student_t(3, 0, 0.05)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.05)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "sp") +
      ...
      if ("all" %in% tolower(random.effect)){
        priors.list[["weibull"]] <- priors.list[["weibull"]] +
          ...
          set_prior("student_t(3, 0, 0.05)", class = "sd", nlpar = "b", group = "site") +
          set_prior("student_t(3, 0, 0.05)", class = "sd", nlpar = "b", group = "sp") +
    ...
    if ("gmm" %in% tolower(names)){
      ...
      if ("all" %in% tolower(fixed.effect)){
        ...
        if (!("none" %in% tolower(random.effect))){
          ...
          priors.list[["gmm"]] <- priors.list[["gmm"]] +
            ...
            set_prior("student_t(3, 0, 0.2)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.2)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "sp") +
            set_prior("student_t(3, 0, 0.2)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.2)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "sp") +
      ...
      if ("all" %in% tolower(random.effect)){
        priors.list[["gmm"]] <- priors.list[["gmm"]] +
          set_prior("student_t(3, 0, 1.5)", class = "sd", nlpar = "a", group = "site") +
          set_prior("student_t(3, 0, 1.5)", class = "sd", nlpar = "a", group = "sp") +
          set_prior("student_t(3, 0, 0.2)", class = "sd", nlpar = "b", group = "site") +
          set_prior("student_t(3, 0, 0.2)", class = "sd", nlpar = "b", group = "sp") +
    ...
    if ("weibull" %in% tolower(names)){
      ...
      if ("all" %in% tolower(fixed.effect)){
        priors.list[["weibull"]] <-    priors.list[["weibull"]] +
          ...
          set_prior("normal(0,0.1)",  nlpar = "k", coef = "liana.catlow") +
          set_prior("normal(0,0.1)",  nlpar = "k", coef = "liana.cathigh")


        if (!("none" %in% tolower(random.effect))){

          priors.list[["weibull"]] <- priors.list[["weibull"]] +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "a", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "a", group = "sp") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "a", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "a", group = "sp") +

            set_prior("student_t(3, 0, 0.004)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.004)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "sp") +
            set_prior("student_t(3, 0, 0.004)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.004)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "sp") +

            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "k", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "k", group = "sp") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "k", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "k", group = "sp")
        }
      ...
      if ("all" %in% tolower(random.effect)){
        priors.list[["weibull"]] <- priors.list[["weibull"]] +
          ...
          set_prior("student_t(3, 0, 0.02)", class = "sd", nlpar = "b", group = "site") +
          set_prior("student_t(3, 0, 0.02)", class = "sd", nlpar = "b", group = "sp") +
          set_prior("student_t(3, 0, 0.1)", class = "sd", nlpar = "k", group = "site") +
          set_prior("student_t(3, 0, 0.1)", class = "sd", nlpar = "k", group = "sp")
    ...
    if ("gmm" %in% tolower(names)){
      ...
      if ("all" %in% tolower(fixed.effect)){
        priors.list[["gmm"]] <- priors.list[["gmm"]] +
          ...
          set_prior("normal(0,4)",  nlpar = "k", coef = "liana.catlow") +
          set_prior("normal(0,4)",  nlpar = "k", coef = "liana.cathigh")
        ...
        if (!("none" %in% tolower(random.effect))){
          ...
          priors.list[["gmm"]] <- priors.list[["gmm"]] +
            ...
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.catlow", nlpar = "b", group = "sp") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "site") +
            set_prior("student_t(3, 0, 0.02)", class = "sd", coef = "liana.cathigh", nlpar = "b", group = "sp") +

            set_prior("student_t(3, 0, 1)", class = "sd", coef = "liana.catlow", nlpar = "k", group = "site") +
            set_prior("student_t(3, 0, 1)", class = "sd", coef = "liana.catlow", nlpar = "k", group = "sp") +
            set_prior("student_t(3, 0, 1)", class = "sd", coef = "liana.cathigh", nlpar = "k", group = "site") +
            set_prior("student_t(3, 0, 1)", class = "sd", coef = "liana.cathigh", nlpar = "k", group = "sp")
        }
      ...
      if ("all" %in% tolower(random.effect)){
        priors.list[["gmm"]] <- priors.list[["gmm"]] +
          ...
          set_prior("student_t(3, 0, 5)", class = "sd", nlpar = "k", group = "site") +
          set_prior("student_t(3, 0, 5)", class = "sd", nlpar = "k", group = "sp")
